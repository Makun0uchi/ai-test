...
from ..repositories.outbox_repository import AccountOutboxRepository
from .publisher import AccountEventMessage, AccountEventPublisher
...
class AccountOutboxDispatcher:
    ...
    async def dispatch_pending(self) -> int:
        ...
        try:
            repository = AccountOutboxRepository(session)
    ...
    def _to_message(self, event: AccountOutbox) -> AccountEventMessage:
