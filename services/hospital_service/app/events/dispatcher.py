...
from ..repositories.outbox_repository import HospitalOutboxRepository
from .publisher import HospitalEventMessage, HospitalEventPublisher


class HospitalOutboxDispatcher:
    def __init__(
        self,
        *,
    ...
    async def dispatch_pending(self) -> int:
        ...
        try:
            repository = HospitalOutboxRepository(session)
    ...
    def _to_message(self, event: HospitalOutbox) -> HospitalEventMessage:
        return HospitalEventMessage(
